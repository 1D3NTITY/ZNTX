    ...
    >
      <body className="min-h-full flex flex-col bg-background text-foreground">
        {/* Boot-Intro-Steuerung. Muss als ALLERERSTES im Body stehen und synchron laufen:
            ...
            Der 2000-Timeout unten ist an die Rack-Power-Up-Sequenz in boot-intro.tsx gekoppelt
            (LED_START_MS + (systems-1)*LED_STAGGER_MS + LED_DURATION_MS + BLOOM_GAP_MS +
            CAPTION_GAP_MS + CAPTION_FADE_MS + HOLD_BEFORE_COLLAPSE_MS, aktuell für das echte
            systems=9 (REAL_SYSTEMS in app/page.tsx, Stand 2026-09-14) berechnet:
            260+560+140+40+150+200+500=1850, aufgerundet + ~140ms Puffer für ein, zwei
            zusätzliche Systeme in der Zukunft = 2000. Dieses Skript kennt den echten
            Systems-Count nicht (statischer String, kein Props-Zugriff), daher der Puffer statt
            exakter Berechnung. Wächst REAL_SYSTEMS in lib/content.ts spürbar, hier neu
            nachrechnen (siehe Formel oben), sonst reißt der Kollaps in eine noch laufende
            LED-Sequenz. */}
        <script
